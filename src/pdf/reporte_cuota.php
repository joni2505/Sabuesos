...
//$numFactura=1010;    
        ...
        $cliente = mysqli_query($conexion, "SELECT cuentas.numero_factura, cliente.nombre, cliente.apellido, cliente.direccion, cliente.celular, cuentas.total_inicio FROM cuentas
...
INNER JOIN cuentas on cuotas.idcuenta=cuentas.idcuenta  WHERE cuotas.numero_factura='$numFactura'");
