         ...
         <?php
                ...
                ?>
                     ...
                     <td><?php echo $data['nombre_marca']; ?></td>
                         ...
                         <td>
                         <a href="eliminar_rubro.php?id=<?php echo $data['idmarca']; ?>" class="btn btn-danger">Eliminar</a>
                         </td>
                     </tr>
             <?php $i++; }
                } ?>
             ...
             <?php
                ...
                ?>
                     ...
                     <td><?php echo $i; ?></td>
                         ...
                         <td>
                         <a href="eliminar_rubro.php?id=<?php echo $data['idrubro']; ?>" class="btn btn-danger">Eliminar</a>
                         </td>
                     </tr>
             <?php $i++; }
                } ?>
