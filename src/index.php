...
$totalClt = mysqli_num_rows($clientes);
$producto = mysqli_query($conexion, "SELECT * FROM producto");
$totalP = mysqli_num_rows($producto);
$ventas = mysqli_query($conexion, "SELECT * FROM locales");
$totalL = mysqli_num_rows($ventas);
$prov = mysqli_query($conexion, "SELECT * FROM proveedores");
$totalProv = mysqli_num_rows($prov);
				...
				<div class="card-body">
					<div class="row no-gutters align-items-center">
						<div class="col mr-2">
							...
							<div class="h5 mb-0 font-weight-bold text-gray-800"><?php echo $totalClt; ?></div>
						</div>
						<div class="col">
									<div class="progress progress-sm mr-2">
										<div class="progress-bar bg-info" role="progressbar" style="width: 50%" aria-valuenow="50" aria-valuemin="0" aria-valuemax="100"></div>
				...
				<div class="card-body">
					<div class="row no-gutters align-items-center">
						<div class="col mr-2">
							...
							<div class="row no-gutters align-items-center">
								<div class="col-auto">
									<div class="h5 mb-0 mr-3 font-weight-bold text-gray-800"><?php echo $totalP; ?></div>
								</div>
								<div class="col">
									<div class="progress progress-sm mr-2">
										<div class="progress-bar bg-info" role="progressbar" style="width: 50%" aria-valuenow="50" aria-valuemin="0" aria-valuemax="100"></div>
					...
					<ul class="list-group">
						...
						<form action="" method=" post" name="frmChangePass" id="frmChangePass" class="p-3">
							<div class="form-group">
								...
								<input type="password" name="actual2" id="actual2" placeholder="Clave Actual" required class="form-control">
							</div>
							<div class="form-group">
								<label>Nueva Contraseña</label>
								<input type="password" name="nueva2" id="nueva2" placeholder="Nueva Clave" required class="form-control">
							</div>
							<div class="form-group">
							...
							<div>
								<button type="submit" class="btn btn-primary btnChangePass" onclick="btnCambiar2(event)">Cambiar Contraseña</button>
							</div>
						</form>
					</ul>
				</div>
