        ...
        <div class="col-lg-12">
            <div class="box-header with-border" id="nuevo">
                ...
                <div class="container-fluid">
                    <label style='color: #9932CC; margin-right: 4%;'>Codigo Producto:</label>
                  
                    <label style='color: #9932CC; margin-right: 12%;'>Nombre del Producto:</label>
                   
                    <label style='color: black; margin-right: 2%;'>Stock Producto:</label>
                ...
                <div class="container">
                    ...
                    <div class="form-group">
                        <label class="col-sm-2 col-form-label">Datos de Ventas</label>
                        <div class="input-group">
                            <input type="number" title="Precio X Menor" class="form-control" id="precio_menor" placeholder="Precio X Menor" required />
                            <span class="input-group-addon">-</span>
                            <input type="number" title="Precio X Mayor" class="form-control" id="precio_mayor" placeholder="Precio X Mayor" required />
                            <span class="input-group-addon">-</span>
                            <input type="number" title="Cantidad" class="form-control" id="cantidad" placeholder="Cantidad" required />
                            <span class="input-group-addon">-</span>
                            <input type="number" title="Descuento" class="form-control" id="descuento" placeholder="descuento" required />
                            <span class="input-group-addon">-</span>
                            <input type="number" title="Interes" class="form-control" id="interes" placeholder="interes" required />
                            <span class="input-group-addon">-</span>
