...
if (!empty($_POST)) {
    ...
    if (empty($_POST['nombre'])  || empty($_POST['direccion'])) {
        ...
        $direccion = $_POST['direccion'];
            $sql_update = mysqli_query($conexion, "UPDATE cliente SET nombre = '$nombre', celular = '$celular', direccion = '$direccion', cuit = '$cuit' WHERE idcliente = '$idcliente'");
                ...
                <div class="card-body">
                    <form class="" action="" method="post">
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" placeholder="Ingrese CUIT" name="cuit" class="form-control" id="cuit" value="<?php echo $cuit; ?>">
                        </div>
                        <div class="form-group">
