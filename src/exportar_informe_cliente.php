                ...
                <div class="col-lg-12">
                    <div class="table-responsive"> 
                        ...
                        <tbody>
                            ...
                            $aci = 0;
                            $i = 1;
                            $query = mysqli_query($conexion, "SELECT producto.nombre_producto, ventas.total_venta'total', cantidad FROM ventas INNER JOIN cliente on ventas.idcliente=cliente.idcliente INNER JOIN producto on ventas.idproducto=producto.idproducto where ventas.idcliente=$idcliente and mes='$mes' and ventas.idlocal=$idlocal and año=$anio");
