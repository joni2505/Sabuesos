...
<div class="container-fluid">
	...
	<div class="d-sm-flex align-items-center justify-content-between mb-4">
		<h2 class="h3 mb-0 text-gray-800"> INFORME MENSUAL VENTAS X MENOR Y MAYOR
    <input type="button" value="ver informe" onclick="imforme_ganancias();" class="btn btn-primary">
